...
"  call Dfunc("s:NFH_html(".a:pagefile.")")
  ...
  if executable("w3m")
"   call Decho("executing !w3m ".page)
   exe "!w3m ".shellescape(a:pagefile,1)
  elseif executable("mozilla")
...
"  call Dfunc("s:NFH_jpg(jpgfile<".a:jpgfile.">)")
  ...
  if executable("mplayer")
   exe "silent! !image-view.sh ".shellescape(a:jpgfile,1)
...
"  call Dfunc("s:NFH_gif(giffile<".a:giffile.">)")
  ...
  if executable("mplayer")
   exe "silent! !mplayer -really-quiet mf://".shellescape(a:giffile,1)
  elseif executable("gimp")
...
"  call Dfunc("s:NFH_png(pngfile<".a:pngfile.">)")
  ...
  if executable("mplayer")
   exe "silent! !mplayer -really-quiet mf://".shellescape(a:pngfile,1)
  elseif executable("gimp")
...
"  call Dfunc("s:NFH_pdf(pdf<".a:pdf.">)")
  if executable("pdf-green.sh")
   exe 'silent! pdf-green.sh '.shellescape(a:pdf,1)
