...
hi OL2 guifg=red	ctermfg=white
hi OL3 guifg=lightblue	ctermfg=white
hi OL4 guifg=violet	ctermfg=white
hi OL5 guifg=white	ctermfg=white
hi OL6 guifg=red	ctermfg=white
hi OL7 guifg=lightblue	ctermfg=white
hi OL8 guifg=violet	ctermfg=white
hi OL9 guifg=white	ctermfg=white

" colors for tags
hi outlTags guifg=darkred	ctermfg=blue
