...
if &background == "light"
	...
	"/ORIG
	hi Folded  ctermfg=grey ctermbg=black guifg=Grey80 guibg=Black
	"hi Folded term=standout ctermbg=grey ctermfg=DarkBlue  guifg=Grey30
	hi FoldColumn   ctermfg=grey guibg=Grey15 guifg=Grey30
...
" Dark background {{{2
	...
	hi OL1 guifg=lightcyan	ctermfg=lightcyan
	hi OL2 guifg=lightyellow ctermfg=yellow
	hi OL3 guifg=lightgreen	ctermfg=lightgreen
	hi OL4 guifg=lightred	ctermfg=lightred
	hi OL5 guifg=white	ctermfg=white
	hi OL6 guifg=white	ctermfg=white
	hi OL7 guifg=white	ctermfg=white
	hi OL8 guifg=white	ctermfg=white
